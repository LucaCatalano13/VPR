...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.self_supervised:
            ...
            return torch.stack(images), torch.stack(images_aug), index.detatch().clone().repeat(self.img_per_place)
        
        return torch.stack(images), None, index.detatch().clone().repeat(self.img_per_place)
